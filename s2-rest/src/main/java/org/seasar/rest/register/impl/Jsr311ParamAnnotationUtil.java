...
public class Jsr311ParamAnnotationUtil {
    private static final Logger log = Logger.getLogger(Jsr311ParamAnnotationUtil.class);

    public static void collectVariableHintFor(Method method, Map<String, Variable> variables) {
    ...
    private static void inspectParam(Map<String, Variable> variables, Annotation[] annotations, Class<?> paramType) {
