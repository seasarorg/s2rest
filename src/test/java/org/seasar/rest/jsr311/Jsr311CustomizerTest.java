...
public class Jsr311CustomizerTest {
	...
	public void setUp() {
		...
		S2ContainerFactory
				.configure("org/seasar/rest/jsr311/s2container.dicon");
		container = S2ContainerFactory
				.create("org/seasar/rest/jsr311/test.dicon");
		container.init();
	...
	public void httpGetAccess() throws Exception {
		SeasarResourceFinder srf = (SeasarResourceFinder) finders
				.get("/employeeService");
	...
	public void httpGetAccessWithArgs() throws Exception {
		SeasarResourceFinder srf = (SeasarResourceFinder) finders
				.get("/employeeService/{employeeId}");
